...
Original file is located at
    https://colab.research.google.com/drive/1fwTT4zEsE_N5HpVPlVnqHkqmn0BooNI8
"""
...
for text in tqdm(captions_doc.split('\n')):
  tokens = text.split(',')
  if len(tokens) < 2:
    continue
...
model.save(os.path.join('/content', 'best_model.h5'))
